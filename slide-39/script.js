/* Slide : Ce que Lina sait faire — generic content-grid entrance */
document.addEventListener('DOMContentLoaded', () => {
    ...
    modCards.forEach((card, i) => {
        setTransition(card, 'opacity 0.6s cubic-bezier(0.22,1,0.36,1), transform 0.6s cubic-bezier(0.22,1,0.36,1)', 1100 + i * 100);
    });
