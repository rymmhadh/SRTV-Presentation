/* Slide : Notre solution — SRTV + Lina */
document.addEventListener('DOMContentLoaded', () => {
    ...
    setTransition(platforms, 'opacity 0.6s ease, transform 0.6s ease', 1200);
    setTransition(modLabel, 'opacity 0.6s ease, transform 0.6s ease', 1500);
    modCards.forEach((card, i) => {
        setTransition(card, 'opacity 0.6s cubic-bezier(0.22,1,0.36,1), transform 0.6s cubic-bezier(0.22,1,0.36,1)', 1500 + i * 90);
    });
