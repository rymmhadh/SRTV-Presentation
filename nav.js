...
(function () {
    ...
    const slideTitles = [
        ...
        "Stack Technique & Environnement", "Architecture du Projet SRTV", "Microservices vs Monolithe", "Architecture événementielle (Kafka)",
        "Qu'est-ce que Lina ?", "Architecture de Lina", "Diagramme de séquence : conversation avec Lina",
