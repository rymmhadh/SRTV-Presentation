...
document.addEventListener('DOMContentLoaded', () => {
    ...
    setTransition(document.querySelector('.diagram-panel'), 'opacity 0.8s cubic-bezier(0.22,1,0.36,1), transform 0.8s cubic-bezier(0.22,1,0.36,1)', 850);
    setTransition(document.querySelector('.versus'), 'opacity 0.8s cubic-bezier(0.22,1,0.36,1), transform 0.8s cubic-bezier(0.22,1,0.36,1)', 850);
    setTransition(document.querySelector('.versus__note'), 'opacity 0.6s ease, transform 0.6s ease', 1350);
