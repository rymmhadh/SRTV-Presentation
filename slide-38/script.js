/* Slide : Qu'est-ce que Lina ? — generic content-grid entrance */
document.addEventListener('DOMContentLoaded', () => {
    ...
    setTransition(modLabel, 'opacity 0.6s ease, transform 0.6s ease', 1100);
    modCards.forEach((card, i) => {
        setTransition(card, 'opacity 0.6s cubic-bezier(0.22,1,0.36,1), transform 0.6s cubic-bezier(0.22,1,0.36,1)', 1200 + i * 120);
    });
